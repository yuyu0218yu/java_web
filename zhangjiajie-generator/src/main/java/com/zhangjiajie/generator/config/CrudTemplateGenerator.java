...
public class CrudTemplateGenerator {
     ...
     * 仅生成Controller
     */
    public static void generateControllerOnly(String entityName, String entityCnName, String moduleName) {
        try {
            generateController(entityName, entityCnName, moduleName);
            printSuccess("Controller生成", entityName, entityName + "Controller.java");
        } catch (IOException e) {
            printError(e.getMessage(), e);
        }
    }
    ...
    public static void generateServiceOnly(String entityName, String entityCnName) {
        try {
            generateService(entityName, entityCnName);
            generateServiceImpl(entityName, entityCnName);
            printSuccess("Service生成", entityName,
                    entityName + "Service.java",
                    entityName + "ServiceImpl.java");
        } catch (IOException e) {
            printError(e.getMessage(), e);
    ...
    private static void generateController(String entityName, String entityCnName, String moduleName) throws IOException {
        ...
        String content = String.format("""
                ...
                entityCnName, getAuthor(), getCurrentDate(), urlPath, moduleName, moduleName, entityName,
    ...
    private static void generateService(String entityName, String entityCnName) throws IOException {
        ...
        String content = String.format("""
                ...
                """,
                basePackage, basePackage, entityName, entityCnName, getAuthor(), getCurrentDate(), entityName, entityName
        );
    ...
    private static void generateServiceImpl(String entityName, String entityCnName) throws IOException {
        ...
        String content = String.format("""
                ...
                entityCnName, getAuthor(), getCurrentDate(), entityName, entityName, entityName, entityName
        );
