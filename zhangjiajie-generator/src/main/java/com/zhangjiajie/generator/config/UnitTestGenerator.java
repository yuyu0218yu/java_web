 ...
 *
 * 方式二：自定义配置后生成
 *   GeneratorHelper.configure("com.zhangjiajie.system", "zhangjiajie", "zhangjiajie-system");
 *   UnitTestGenerator.generate("User", "用户");
 *
 * @author yushuang
 */
public class UnitTestGenerator {
     ...
     * 仅生成Controller测试
     */
    public static void generateControllerTestOnly(String entityName, String entityCnName) {
        try {
            generateControllerTest(entityName, entityCnName);
            printSuccess("Controller测试生成", entityName, entityName + "ControllerTest.java");
        } catch (IOException e) {
            printError(e.getMessage(), e);
        }
    }
     ...
     * 仅生成Service测试
     */
    public static void generateServiceTestOnly(String entityName, String entityCnName) {
        try {
            generateServiceTest(entityName, entityCnName);
            printSuccess("Service测试生成", entityName, entityName + "ServiceTest.java");
        } catch (IOException e) {
            printError(e.getMessage(), e);
        }
    }
    ...
    private static void generateControllerTest(String entityName, String entityCnName) throws IOException {
        ...
        String content = String.format("""
                ...
                entityCnName, getAuthor(), getCurrentDate(), entityName, entityName, entityName,
    ...
    private static void generateServiceTest(String entityName, String entityCnName) throws IOException {
        ...
        String content = String.format("""
                ...
                """,
                basePackage, basePackage, entityName, basePackage, entityName, basePackage, entityName,
                entityCnName, getAuthor(), getCurrentDate(), entityName, entityName,
